...
let squirrelLayers = {}; // makes a global object to store layers, each keyed by squirrel's number
...
//check data is there
    ...
    map2.setView([squirrelData.marker.getLatLng().lat, squirrelData.marker.getLatLng().lng], 7);
  });
